...
def test_initialization(web_driver_base_parser, mock_driver):
...
def test_get_element_with_wait_success(web_driver_base_parser, mock_driver):
...
def test_get_element_with_wait_timeout(web_driver_base_parser, mock_driver):
