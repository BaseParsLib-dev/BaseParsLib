...
def split_on_chunks_by_count_chunks(array: list | tuple, count_chunks: int) -> Iterator:
    """
...
def split_dict_on_chunks_by_chunk_len(dictionary: dict, chunk_len: int) -> Iterator[dict]:
    """
